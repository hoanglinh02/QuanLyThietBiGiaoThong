...
<table class="table table-bordered" id="tbl_nhacungcap" style="width: 100%">
    <thead>
        <tr class="bg-info">
            ...
            <th style="width: 35%;">Giấy phép kinh doanh</th>
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#" onclick="ThemMoiLoaiPhuTung(<?php echo $result['CongTySuDungID'] ?>)"><i class="fas fa-edit"></i> Sửa</a>
                                <a class="dropdown-item" href="#" onclick="XoaLoaiPhuTung(<?php echo $result['CongTySuDungID'] ?>)" ><i class="fas fa-trash-alt"></i> Xóa</a>
                            </div>
                        </div>     
                    </td>
                </tr>
