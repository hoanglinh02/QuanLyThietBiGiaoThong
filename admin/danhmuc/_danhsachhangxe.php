...
<table class="table table-bordered" id="tbl_nhacungcap" style="width: 100%">
    <thead>
        <tr class="bg-info">
            ...
            <th style="width: 45%;">Tên hãng xe</th>
            <th style="width: 25%;">Nước sản xuất</th>
    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $result['NuocSanXuat'] ?></td>
                    ...
                    <td>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="#" onclick="ThemMoiLoaiPhuTung(<?php echo $result['HangXeID'] ?>)"><i class="fas fa-edit"></i> Sửa</a>
                                <a class="dropdown-item" href="#" onclick="XoaLoaiPhuTung(<?php echo $result['HangXeID'] ?>)" ><i class="fas fa-trash-alt"></i> Xóa</a>
                            </div>
                        </div>     
                    </td>
                </tr>
